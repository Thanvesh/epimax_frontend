...
class SignIn extends Component {
  ...
  handleSubmit = async event => {
    ...
    const response = await fetch(' https://epimax-server.onrender.com/login', {
      method: 'POST',
      headers: {
      ...
      <div className="login-container">
        <div className='signin-container'>
          ...
          <form onSubmit={this.handleSubmit} className="login-form-container">
            ...
            <p className='signup-text'>Not a Member ? <span className='signup'><Link to="/signup">Sign up here</Link></span>.</p>
